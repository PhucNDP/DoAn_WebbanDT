...
namespace Project3.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            // lấy role để cung cấp cho giao diện đăng kí
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AplicationUser { UserName = Input.Email, Email = Input.Email, FullName=Input.FullName, Birthday=Input.Birthday };
